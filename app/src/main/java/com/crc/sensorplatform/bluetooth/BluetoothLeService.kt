...
//    }
    ...
    fun setDrivingCharacteristicNotification(characteristic: BluetoothGattCharacteristic,
        ...
        if (UUID_CHESTPOD_STATE == characteristic.uuid) {
...
//            Log.e("eleutheria", "end")
    ...
    fun setMCNotification(enabled: Boolean) {
        ...
        val uuidMCCharateristic = SampleGattAttributes.CHARACTERISTIC_CHESTPOD_STATE
        val uuidMCService = SampleGattAttributes.SERVICE_CHESTPOD_STATE
    ...
    companion object {
        ...
        val UUID_CHESTPOD_STATE = UUID.fromString(SampleGattAttributes.CHARACTERISTIC_CHESTPOD_STATE)
    }
}